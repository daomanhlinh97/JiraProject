...
import com.dxc.graphql.service.datafetcher.AddingBookDataFetcher;
import com.dxc.graphql.service.datafetcher.AllBooksDataFetcher;
import com.dxc.graphql.service.datafetcher.BookDataFetcher;
...
public class GraphQLService {
	...
	private AddingBookDataFetcher addingBookDataFetcher;
	...
	public GraphQLService(BookRepository bookRepository, AllBooksDataFetcher allBooksDataFetcher,
			BookDataFetcher bookDataFetcher, AddingBookDataFetcher addingBookDataFetcher) {
		this.bookRepository = bookRepository;
		this.allBooksDataFetcher = allBooksDataFetcher;
		this.bookDataFetcher = bookDataFetcher;
		this.addingBookDataFetcher = addingBookDataFetcher;
	}
	...
	private RuntimeWiring buildRuntimeWiring() {
        return RuntimeWiring.newRuntimeWiring()
                ...
                .type("Mutation", typeWiring -> typeWiring
                		.dataFetcher("addBook", addingBookDataFetcher))
                .build();
    }
